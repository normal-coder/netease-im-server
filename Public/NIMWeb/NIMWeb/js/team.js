...
var myTeam = {
	...
	showUserList: function(type,teamType) {
		...
		this.$createTeamContainer.load('../../../index.php/NIMWeb/Index/createteam.html', function() {
	...
	showTeamInfo: function(o) {
		var $this = $(o),
	 		that = this;
		this.$teamInfoContainer.load('../../../index.php/NIMWeb/Index/teaminfo.html', function() {
			// 获取群成员
